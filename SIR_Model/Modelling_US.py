...
def learning_beta(df,X1,y1):
    ...
    tscv = TimeBasedCV(train_period=45,test_period=10,freq='days')
...
def infectivity():
    ...
    COUNTRY LEVEL INFO
    ==================================
    UK- 5067.0,234.0,67.0 N=67,886,011
    US - 76,0,7 N=331002651
    Canada - 12978.0,218.0,2577.0,0.24757281553398058 N=37742154
    """
    ...
    beta, gamma = 0.576277, 0.0078  # Inline with the current trend
    beta1, gamma1 = 0.2458, 0.0050  # Predicted transmission values
    ...
    plt.text(x=-2.5, y=100000, s=f'Actual Beta: {beta}', horizontalalignment='left')
    plt.text(x=53, y=7550, s=f'Learned Beta: {beta1}')
...
def recovery():
    ...
    ax.set_xlabel('Time in days of the Disease Outbreak')
    ax.set_ylabel('Population in 1000s')
    plt.text(x=16, y=42500, s=f'Actual Gamma: {gamma}', horizontalalignment='left')
    plt.text(x=35, y=2500, s=f'Learned Gamma:{gamma1}')
